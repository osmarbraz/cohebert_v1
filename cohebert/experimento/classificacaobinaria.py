...
# ============================
def carregaResultadoAvaliacaoFold(model_args, training_args, DIRETORIO_AVALIACAO):
    '''
...
# ============================        
def salvaResultadoClassificacaoFold(model_args, DIRETORIO_CLASSIFICACAO, lista_resultado_avaliacao):
    '''
...
# ============================        
def salvaResultadoAvaliacaoFold(model_args, training_args, DIRETORIO_AVALIACAO, acc, rec, pre, f1, vp_s, vn_s, fp_s, fn_s):
    '''
